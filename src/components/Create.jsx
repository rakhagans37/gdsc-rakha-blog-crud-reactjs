...
function Create({title, setTitle ,description, setDescription, image, setImage}) {
    return (
        <div className="flex w-screen justify-center">
            <div className="flex flex-col w-max pt-16 gap-9 items-start">
                ...
                <div className="flex flex-col gap-6">
                    <label htmlFor="title" className="flex flex-col items-start gap-2">
                    ...
                    <label htmlFor="description" className="flex flex-col items-start gap-2">
                    ...
                    <label htmlFor="image" className="flex flex-col items-start gap-2">
                        <h2 className="text-base font-semibold">Gambar / Thumbnail</h2>
